package com.example.callbus.Member.Lessee.entity;
...
@NoArgsConstructor
@AllArgsConstructor
public class Lessee extends Timestamped {
    @Id
    ...
    public Lessee(MemberRequestDto memberRequestDto, Authority authority) {
